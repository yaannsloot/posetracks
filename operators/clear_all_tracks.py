...
class ClearAllTracksOperator(bpy.types.Operator):
    """Delete all tracks"""
    bl_idname = "motionengine.clear_tracks_operator"
    bl_label = "Clear all"
        ...
        if not global_vars.ui_lock_state:
            ...
            if clip_data is not None:
                ...
                if pose_tracks_list is not None:
                    me_data.clear_tracks(current_clip, pose_tracks_list, ignore_keep=True)

        return {'FINISHED'}


CLASSES = [
    ClearAllTracksOperator
]
