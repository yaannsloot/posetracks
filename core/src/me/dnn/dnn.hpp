...
namespace me {
	...
	namespace dnn {
		...
		struct Tag {
			...
			Tag(const std::pair<double, double>& ca, const std::pair<double, double>& cb, const std::pair<double, double>& cc, const std::pair<double, double>& cd) :
			...
			Tag(int id, const std::pair<double, double>& ca, const std::pair<double, double>& cb, const std::pair<double, double>& cc, const std::pair<double, double>& cd) : 
			...
			Tag(double conf, const std::pair<double, double>& ca, const std::pair<double, double>& cb, const std::pair<double, double>& cc, const std::pair<double, double>& cd) :
			...
			Tag(int id, double conf, const std::pair<double, double>& ca, const std::pair<double, double>& cb, const std::pair<double, double>& cc, const std::pair<double, double>& cd) :
