...
namespace me::tracking {
	...
	struct TrackingData {
        ...
        void set_pose(const int frame, const std::string name, const dnn::Pose& pose);
        void set_joint(const int frame, const std::string name, const int id, const dnn::Joint& joint);
        ...
        void set_detection(const int frame, const std::string name, const dnn::Detection& det);
        void set_tag(const int frame, const int id, const dnn::Tag& tag);
	};
