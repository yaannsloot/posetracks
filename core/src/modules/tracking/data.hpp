...
/// </summary>
using PoseIDMap = std::unordered_map<std::string, Pose>;
...
/// </summary>
using DetectionIDMap = std::unordered_map<std::string, Detection>;
...
/// </summary>
using TagIDMap = std::unordered_map<int, Tag>;
...
struct TrackingData {
    ...
    void set_pose(const int frame, const std::string name, const Pose& pose);
    void set_joint(const int frame, const std::string name, const int id, const Joint& joint);
    void set_joint(const int frame, const std::string name, const int id, const cv::Point2d& pt, const double prob);
    void set_joint(const int frame, const std::string name, const int id, const double x, const double y, const double prob);
    void set_detection(const int frame, const std::string name, const Detection& det);
    void set_tag(const int frame, const int id, const Tag& tag);
};
